            ...
            <div className="container">
                <div className="header-wrapper">
                    ...
                    <ul className="nav-items">
                        ...
                        <li className="nav-item" style={{display:  (localStorage.getItem('name') != '' && localStorage.getItem('name') != undefined && localStorage.getItem('name') != null )  ? 'none' : ''}}>
                    ...
                    <a className="nav-btn" href="#/create-account" style={{display:  (localStorage.getItem('name') != '' && localStorage.getItem('name') != undefined && localStorage.getItem('name') != null )? 'none' : ''}}>Sign up Free</a>
                    <p className="nav-btn" style={{display: (localStorage.getItem('name') != '' && localStorage.getItem('name') != undefined && localStorage.getItem('name') != null ) ? '' : 'none'}}>{'Welcome ' + localStorage.getItem('name')}</p>
