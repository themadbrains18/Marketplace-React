    ...
    return (
            <div className="card-body" style={{cursor:'pointer'}} onClick={click} key={props.id} url={props.url} >
                ...
                <div className="card-footer">
                    <img src={require(`../assets/svg/${props.logoUrl}`).default} alt="product logo" />
                    <div className="card-txt">
                        <p className="card-info">{props.heading}</p>
                        <div className="card-sub-heading-wrapper">
                            <p className="card-sub-info">{props.cardType }</p>
